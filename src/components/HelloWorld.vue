 ...
 <div class="hello">
  ...
  <header class="l-header" id="header">
      <nav class="nav bd-container">
          <div class="col-lg-6"><a href="index.html" style="text-decoration:none;">
                  <h1 style="color: #00a082;">Khan Saray</h1>
              </a></div>
          <div class="nav__menu" id="nav-menu">
              <ul class="nav__list">
                  <li class="nav__item"><a href="#home" class="nav__link active-link">На главную</a></li>
                  <li class="nav__item"><a href="#about" class="nav__link">О нас</a></li>
                  <li class="nav__item"><a href="#services" class="nav__link">Сервисы</a></li>
  ...
  <main class="l-main">
      ...
      <section class="home" id="home">
          <div class="home__container bd-container bd-grid">
              <div class="home__data">
                  <h1 class="home__title">Вкусные блюда</h1>
                  <h2 class="home__subtitle">Попробуйте лучшее этой <br> недели.</h2>
                  <a href="menu.html" class="button">Открыть меню</a>
              </div>
              <img src="files/img/home.png" alt="" class="home__img">
          </div>
      </section>
      <!--========== ABOUT ==========-->
      <section class="about section bd-container" id="about">
          <div class="about__container  bd-grid">
              <div class="about__data">
                  ...
                  <h2 class="section-title about__initial">Мы готовим <br> лучшие блюда</h2>
                  <p class="about__description">Мы готовим лучшую еду во всем городе, с отличным обслуживанием
                      клиентов, лучшими блюдами и по лучшей цене, приходите к нам.</p>
              </div>
              <img src="files/img/about.jpg" alt="" class="about__img">
          </div>
      </section>
      <!--========== SERVICES ==========-->
      <section class="services section bd-container" id="services">
          <h2 class="section-title">Наши поразительные сервисы</h2>
          <div class="services__container  bd-grid">
              <div class="services__content">
                  ...
                  <h3 class="services__title">Великолепная еда</h3>
                  <p class="services__description">Мы предлагаем нашим клиентам услуги высочайшего качества на
                      протяжении многих лет с лучшей и вкусной едой в городе.</p>
              </div>
              <div class="services__content">
                  <svg class="services__img" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <h3 class="services__title">Фаст-фуд</h3>
                  <p class="services__description">Вкусная пища - залог прекрасного настроения и энергии.У нас самые
                      вкусные фаст-фуды сделанные с любовью.</p>
              </div>
              <div class="services__content">
                  <svg class="services__img" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0)">
                  ...
                  <p class="services__description">Доставка - станет настоящим спасением для домохозяек. Вы можете
                      отложить свой фартук и посуду в сторону и наконец-то позволить себе отдохнуть!</p>
              </div>
          </div>
      </section>
      <!--========== MENU ==========-->
      <section class="menu section bd-container" id="menu">
          <h2 class="section-title">Меню этой недели</h2>
          <div class="menu__container bd-grid">
              <div class="menu__content">
                  <img src="files/img/plate1.png" alt="" class="menu__img">
                  <h3 class="menu__name">Салат барбекю</h3>
                  <span class="menu__detail">Куриное филе, обжаренное на гриле под соусом Барбекю</span>
                  <span class="menu__preci">1500₸</span>
                  <a href="" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
              </div>
              <div class="menu__content">
                  <img src="files/img/plate2.png" alt="" class="menu__img">
                  <h3 class="menu__name">Салат с рыбой</h3>
                  <span class="menu__detail">Кусочки рыбы горячего копчения с листьями салата, помидорами, творожным
                      сыром с добавлением миндального ореха. заправляется оливковым маслом и горчичной
                      заправкой.</span>
                  <span class="menu__preci">1400₸</span>
                  <a href="" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
              </div>
              <div class="menu__content">
                  <img src="files/img/plate3.png" alt="" class="menu__img">
                  <h3 class="menu__name">Салат из шпината</h3>
                  <span class="menu__detail">Листья шпината, ростбиф, томаты черри, сыр, лук-шалот. Заправляется
                      маслом и бальзамическим уксусом</span>
                  <span class="menu__preci">1200₸</span>
                  <a href="" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
              </div>
          </div>
      </section>
      ...
      <section class="app section bd-container">
          <div class="app__container bd-grid">
              <div class="app__data">
                  <span class="section-subtitle app__initial">Веб-версия</span>
                  <h2 class="section-title app__initial">Приложение не требуется</h2>
                  <p class="app__description">Не требуется установка приложения, вы можете делать заказы прямо из
                      вашего браузера. Вы можете оформить заказ позвонив нам или написав!</p>
              </div>
              <img src="files/img/movil-app.png" alt="" class="app__img">
          </div>
      </section>
      <!--========== CONTACT US ==========-->
      <section class="contact section bd-container" id="contact">
          <div class="contact__container bd-grid">
              <div class="contact__data">
                  <span class="section-subtitle contact__initial">Давайте поговорим</span>
                  <h2 class="section-title contact__initial">Свяжитесь с нами!</h2>
                  <p class="contact__description">Если вы хотите зарезервировать столик в нашем ресторане или заказать
                      еду, свяжитесь с нами, и мы быстро вас обслужим с помощью нашей круглосуточной службы чата.</p>
              </div>
              <div class="contact__button">
                  <a href="tel:+7 707 128 7 128" class="button">Позвоните нам</a>
                  <a href="https://wa.me/+7 705 55 88 333" class="button">Напишите нам</a>
              </div>
          </div>
      </section>
  </main>
  ...
  <footer class="footer section bd-container">
      <div class="footer__container bd-grid">
          <div class="footer__content">
              <a class="footer__logo">Мы в социальных сетях!</a>
              <div>
                  <a href="https://vk.com/id420548201" class="footer__social"><i class='bx bxl-vk'></i></a>
                  <a href="https://www.instagram.com/khan_saray_almaty/" class="footer__social"><i
                          class='bx bxl-instagram'></i></a>
                  <a href="https://twitter.com/home" class="footer__social"><i class='bx bxl-twitter'></i></a>
              </div>
          </div>
          <div class="footer__content">
              <a class="footer__logo">Информация о нас!</a>
              <ul>
                  <li><a>Наши контакты:</a></li>
                  <li>+7 707 128 7 128</li>
                  <li>dimash.amurzakov@gmail.com</li>
              </ul>
          </div>
          <div class="footer__content">
              <a class="footer__logo">Адреса:</a>
              <ul>
                  <li>Алматы</li>
                  <li>Ул.Толе би 128</li>
              </ul>
          </div>
      </div>
      <p class="footer__copy">&#169; 2020 Amurzakov. All right reserved</p>
  </footer>
 </div>
</template>
